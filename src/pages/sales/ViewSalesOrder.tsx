...
import { ShoppingCart, ArrowLeft, User, Calendar, MapPin, Phone, Mail, FileText, Edit } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900 font-medium">{orderData.order_number}</p>
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-2">
                      ...
                      <span className={`inline-flex px-3 py-1 text-xs leading-5 font-semibold rounded-full ${getPaymentStatusColor(orderData.payment_status)}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900 font-medium">{orderData.customer.name}</p>
                  </div>
                  <div>
              ...
              <div className="space-y-3">
                ...
                {orderData.discount_amount > 0 && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900">-₹{orderData.discount_amount.toFixed(2)}</span>
                  </div>
                )}
