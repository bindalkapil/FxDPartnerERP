/*
  # Create current_inventory table with proper data handling
  ...
  1. New Tables
    - `current_inventory`
      ...
      - Unique constraint on (product_id, sku_id)
  ...
  3. Changes
    ...
    - Initialize with data from completed vehicle arrivals using UPSERT
*/
...
-- Use UPSERT (INSERT ... ON CONFLICT) to handle existing data
