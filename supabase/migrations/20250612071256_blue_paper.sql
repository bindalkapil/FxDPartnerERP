/*
  ...
  3. Changes
    - Creates unique constraint on (product_id, sku_id)
    - Adds indexes for performance
    - Creates trigger for updating updated_at timestamp
    - Initializes table with data from completed vehicle arrivals
*/
...
-- First, create a temporary view to ensure we get unique combinations
CREATE TEMPORARY VIEW inventory_aggregation AS
SELECT 
  vai.product_id,
  vai.sku_id,
...
-- Now insert the data using the temporary view
...
DROP VIEW inventory_aggregation;