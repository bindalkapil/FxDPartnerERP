/*
  # Create current inventory table with proper data initialization
  ...
  3. Changes
    ...
    - Initialize with data from vehicle arrivals using UPSERT to avoid duplicates
*/
...
-- Initialize current_inventory with data from existing vehicle arrivals using UPSERT
-- This will insert new records or update existing ones to avoid duplicate key errors
